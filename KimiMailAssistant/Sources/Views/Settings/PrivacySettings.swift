...
struct PrivacySettings: View {
    ...
    private func calculateDataSize() {
        ...
        guard let cacheURL = paths.first?.appendingPathComponent("KimiMailAssistant") else {
            dataSize = "0 MB"
            return
        }
    ...
    private func clearAllData() {
        ...
        let paths = FileManager.default.urls(for: .cachesDirectory, in: .userDomainMask)
        if let cacheURL = paths.first?.appendingPathComponent("KimiMailAssistant") {
    ...
    private func exportData() {
        ...
        panel.nameFieldStringValue = "KimiMailAssistant-Data-Export.json"
